    ...
    public class Camera
    {
        ...
        public void ProjectToScreen(SpriteBatch spriteBatch)
        {
            ...
            if (SceneOverlay is SpriteSheet spriteSheet)
                ...
                GraphicsRenderer.DrawComponent(Overlay, Vector2.Zero, pos, spriteBatch);
            ...
            foreach (Hitbox b in Scene.hitboxestodraw)
                if (b is CircularHitbox c)
                    ...
                    GraphicsRenderer.DrawRectangle(spriteBatch, b.pos, b.size, pos, Color.Red, blankRect);

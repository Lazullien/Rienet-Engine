...
namespace Rienet
{
    ...
    public class LightSource : GraphicsComponent
    {
        ...
        public LightSource(Vector2 InWorldPos, Vector2 RawSize, float Radius, float Gamma, Color Tint, Scene scene, IGameObject belongedObject) : base(Vector2.Zero, RawSize)
        {

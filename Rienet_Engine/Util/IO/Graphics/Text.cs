...
namespace Rienet
{
    public class Text : UI
    {
        ...
        public Text(Vector2 Pos, float TextScale, Vector2 RawSize, bool UpdateFirst, SpriteFont spriteFont) : base(Pos, RawSize, UpdateFirst)
        {
        ...
        public void SetLines()
        {
            ...
            {
                //Debug.WriteLine(spriteFont.Characters.Count);

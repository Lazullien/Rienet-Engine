...
namespace Rienet
{
    public class AudioHandler
    {
        ...
        /// </summary>
        public static float MasterVolume { get; private set; } = 0.2f;
        ...
        /// <summary>
        /// after this, don't forget to update components to new volume with UpdateComponentsToVolume()
        /// </summary>
        ...
        /// after this, don't forget to update components to new volume with UpdateComponentsToVolume()
        /// </summary>
        public static void ResetMasterVolume() => MasterVolume = 0.2f;

        public static void UpdateComponentsToVolume()
        {
            foreach (var component in AudioComponents.Values)
            {
                component.SetVolume(MasterVolume);
            }
        }
